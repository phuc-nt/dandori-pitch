...
- [Approval Workflow]({{ site.baseurl }}{% link modules/architecture-modules-approval-workflow.md %}) — every decision audited here
- [Lifecycle Hooks]({{ site.baseurl }}{% link modules/architecture-modules-lifecycle-hooks.md %}) — every hook execution audited
