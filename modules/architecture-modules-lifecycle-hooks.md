...
- [Approval Workflow]({{ site.baseurl }}{% link modules/architecture-modules-approval-workflow.md %}) — uses `on_approval_request` hook for custom routing
- [Audit Log]({{ site.baseurl }}{% link modules/architecture-modules-audit-log.md %}) — every hook execution logged
- [Cost Attribution]({{ site.baseurl }}{% link modules/architecture-modules-cost-attribution.md %}) — `on_budget_exceeded` fires from this module
