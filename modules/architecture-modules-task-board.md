...
- [Approval Workflow]({{ site.baseurl }}{% link modules/architecture-modules-approval-workflow.md %}) — gates tasks at status REVIEW
- [Skill Library]({{ site.baseurl }}{% link modules/architecture-modules-skill-library.md %}) — supplies skill metadata for matcher
