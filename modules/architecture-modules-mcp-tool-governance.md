...
- [Inline Sensors]({{ site.baseurl }}{% link modules/architecture-modules-inline-sensors.md %}) — sensors are Dandori-published MCP tools governed by this module
- [Skill Library]({{ site.baseurl }}{% link modules/architecture-modules-skill-library.md %}) — `fetch_skill` is also a Dandori-published MCP tool
- [Audit Log]({{ site.baseurl }}{% link modules/architecture-modules-audit-log.md %}) — every MCP tool invocation logged
